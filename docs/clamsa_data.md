...
Tiberius de novo training and prediction uses ClaMSA data as numpy array as input. Following describes the steps to generate the data for one species for Tiberius in de novo mode:
